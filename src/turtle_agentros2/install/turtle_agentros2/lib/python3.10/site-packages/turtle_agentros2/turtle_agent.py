...
class TurtleAgent(ROSA):
    ...
    def __init__(self, streaming: bool = False, verbose: bool = True):
        ...
        self.turtle_agent = TurtleAgent(verbose=False, streaming=streaming)
        self.get_logger().info("Turtle Agent Initialized")
    ...
    def run_agent(self):
        asyncio.create_task(self.turtle_agent.run())
...
def main():
    ...
    #streaming = get_parameter('streaming').get_parameter_value().bool_value
    #self.get_logger().info("Turtle Agent initialized.")
